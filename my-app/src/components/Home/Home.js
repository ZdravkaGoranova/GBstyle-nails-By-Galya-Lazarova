...
export default function Home() {
    ...
    return (
        <>
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" style={{ marginTop: "60px", position: "absolute", left: "1%", opacity: " 0.85" }}>
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        ...
                                        <a href="https://gayanails.com/" className="card-link"><img src="img/viber_image_2022-11-02_22-06-15-886.jpg" width="200" height="100" alt="..." /> </a>
                                        <p><a href="https://gayanails.com/" class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">🌸 https://gayanails.com 🌸</a></p>
                                        <a className="nav-link" href="https://gayanails.com/"><p className="card-title"><small className="text-body-secondary">Висококачествени продукти за маникюр, педикюр и ноктопластика</small> </p></a>
            ...
            {/* <div id=" carouselExampleAutoplaying" className="carousel-dark slide" data-bs-ride="carousel" style={{ marginTop: "60px", position: "absolute", left: "1%", opacity: " 0.85" }}>
