                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        ...
                        <div class="card mb-3" >
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="img/viber_image_2023-04-21_13-46-52-080.jpg" className=" img-fluid w-150 " alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p class="card-text">Здравейте скъпи клиенти, каним Ви да се насладите на незабравими релакциращи и разкрасяващи процедури специално за Вас. Очакваме Ви, екипът на GBstyle-nails By Galya Lazarova.</p>
                                       
                                            <p class="card-text"><small class="text-body-secondary"> Може да се свържете с нас на един от следните канали, удобни  за Вас </small></p>
                                        ...
                                        <ul className="list-group list-group-flush" >
                                            ...
                                            <li className="list-group-item">
                                                <a href="https://gbstyle.customer.fitsys.co/reservations/confirm?date=2022-02-25T11%3A45%3A00%2B02%3A00&services=82072&site=1" className="card-link"><img src="img/event-accepted.png" width="30" height="30" alt="..." /> </a>Запази час за посещение</li>
                                            <li className="list-group-item">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                        ...
                        <div class="card mb-3" >
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Професионални курсове </h5>
                                        <p class="card-text">Ако желаете да се преквалифицирате и да станете профионалист в нова или любима от много време професия може да се възползвате като се запишете за един от следните курсове по:</p>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <a class="nav-link" href="https://gayanails.com/"><h5 class="card-title">Gaya Professional </h5></a>
                                        <p class="card-text">GBstyle-nails By Galya Lazarova  работи с професиоланлни високо качествени немски  продукти, които са  100% веган и с формула премахнала 8 неподходящи съставки.</p>
                                        ...
                                        <p class="card-text"><small class="text-body-secondary">Висококачествени продукти заманикюр, педикюр и ноктопластика</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item" data-bs-interval="4000">
                        ...
                        <div class="card mb-3" >
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Здравейте дами нещо ново за Вас </h5>
                                        <p class="card-text">💫⭐️АРОМА СВЕЩИ GAYA ✨в два прекрасни аромата.</p>
                                        <a href="https://gayanails.com/" className="card-link"><img src="img/viber_image_2022-11-02_22-06-15-886.jpg" width="200" height="100" alt="..." /> </a>

                                        <a class="nav-link" href="https://gayanails.com/"><p class="card-title"><small class="text-body-secondary">Висококачествени продукти заманикюр, педикюр и ноктопластика</small> </p></a>
