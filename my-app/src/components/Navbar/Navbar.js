...
export default function Navbar() {
    return (
        ...
        <nav class="navbar navbar-dark bg-dark fixed-top" style={{  height: "80px" }}>
  <div class="container-fluid">
    ...
    <a href="https://gbstyle.customer.fitsys.co/login?fbclid=IwAR30MlNCsrsaiEGZE6heIpc3mkRZ2q5GPxpS33eFXqoMLbeeRSmqayojO7U"
     className="card-link mb-1"><img src="img/viber_image_2023.png" width="170" height="70" alt="..."
                                            style={{ marginTop: "-40px", position: "absolute", }} /> </a>
                                             {/* <p id="logoNavbar" class="navbar-brand" href="/">GBstyle  - nails By Galya Lazarova</p> */}
    {/* <h2 id="logoNavbar" class="navbar-brand" href="/">GBstyle  - nails By Galya Lazarova</h2> */}
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
    MENU
    </button>
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">MENU<figcaption className="blockquote-footer" style={{ fontSize:"15px", marginBlockStart:"3px" }}>
