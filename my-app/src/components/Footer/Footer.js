...
export default function Footer() {
    ...
    return (
        ...
        <footer className="navbar-dark bg-dark " style={{
            ...
            <div >
                ...
                GBstyle-nails By Galya Lazarova | Всички права запазени!  | Web design by :
                <a href="https://github.com/ZdravkaGoranova" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Zdravka Goranova</a>
            </div>
        </footer >
