    ...
    return (
        ...
        <footer  >
            <div >
                ...
                <section style={{ display: "flex", justifyContent: "left", gap: "10px" }}>

                    <article>
                        <ul style={{ stopOpacity: "none" }}>
                            <li>
                                ...
                                <a href="https://instagram.com/gb_style_by_galya_lazarova?igshid=YmMyMTA2M2Y=" className="card-link"><img src="img/instagram-new.png" width="20" height="20" alt="instagram-new.png" /></a> <a href="https://www.facebook.com/GBStylebyGalyalazarova/photos" className="card-link"><img src="img/facebook-circled.png" width="20" height="20" alt="facebook-circled.png" /> </a>
                            ...
                            <li>  <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
                                MENU
                            </button>
                            </li>
                        </ul>
                    ...
                    <article>
                        <ul>
                            <li><a href="/" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">© Copyright Zdravka Goranova, 2023</a></li>
                            <li><a href="/" className="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">All rights reserved GBstyle - nails By Galya Lazarova</a></li>
